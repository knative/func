...
func TestClient_New(t *testing.T) {
	...
	if _, err := client.New(context.Background(), fn.Function{Root: root, Runtime: TestRuntime}); err != nil {
		t.Fatal(err)
	}
}
...
func TestClient_New_RuntimeRequired(t *testing.T) {
	...
	_, err := client.New(context.Background(), fn.Function{Root: root})
	if err == nil {
...
func TestClient_New_NameDefaults(t *testing.T) {
	...
	if _, err := client.New(context.Background(), f); err != nil {
		t.Fatal(err)
	}
...
func TestClient_New_WritesTemplate(t *testing.T) {
	...
	if _, err := client.New(context.Background(), fn.Function{Runtime: TestRuntime, Root: root}); err != nil {
		t.Fatal(err)
	}
...
func TestClient_New_ExtantAborts(t *testing.T) {
	...
	if _, err := client.New(context.Background(), fn.Function{Root: root}); err == nil {
...
func TestClient_New_RepositoriesExtensible(t *testing.T) {
	...
	if _, err := client.New(context.Background(), fn.Function{Root: root, Runtime: "test", Template: "customTemplateRepo/tplc"}); err != nil {
		t.Fatal(err)
	}
...
func TestClient_New_RuntimeNotFoundError(t *testing.T) {
	...
	_, err := client.New(context.Background(), fn.Function{Root: root, Runtime: "invalid"})
...
func TestClient_New_RuntimeNotFoundCustom(t *testing.T) {
	...
	_, err := client.New(context.Background(), f)
	if !errors.Is(err, fn.ErrRuntimeNotFound) {
...
func TestClient_New_Named(t *testing.T) {
	...
	if _, err := client.New(context.Background(), fn.Function{Runtime: TestRuntime, Root: root, Name: name}); err != nil {
		t.Fatal(err)
	}
...
func TestClient_Deploy_RegistryUpdate(t *testing.T) {
	...
	if _, err := client.New(context.Background(), fn.Function{Runtime: "go", Name: "f", Root: root}); err != nil {
		t.Fatal(err)
	}
	f, err := fn.NewFunction(root)
	if err != nil {
...
func TestClient_New_BuildersPersisted(t *testing.T) {
	...
	if _, err := client.New(context.Background(), f0); err != nil {
		t.Fatal(err)
	}
...
func TestClient_New_BuildpacksPersisted(t *testing.T) {
	...
	client := fn.New(fn.WithRegistry(TestRegistry))
	if _, err := client.New(context.Background(), fn.Function{
		Runtime: TestRuntime,
		Root:    root,
		Build: fn.BuildSpec{
