...
require (
	...
	knative.dev/client/pkg v0.0.0-20260216143005-d57633b2129f
	...
	knative.dev/serving v0.48.1-0.20260216124004-39737a990c63
)
...
require (
	...
	knative.dev/networking v0.0.0-20260216015902-5b4233372a98 // indirect
