...
require (
	...
	knative.dev/client/pkg v0.0.0-20260330024304-f389dba1a27b
	...
	knative.dev/serving v0.48.1-0.20260330124104-098fe866e369
)
...
require (
	...
	knative.dev/networking v0.0.0-20260320015802-dd06704493e2 // indirect
