...
func NewConfigCICmd(
	...
	gitCgb common.GetCgbFunc,
	getCwd common.GetCwdFunc,
) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "ci",
		...
		RunE: func(cmd *cobra.Command, args []string) (err error) {
			return runConfigCIGitHub(cmd, loaderSaver, writer, gitCgb, getCwd)
		},
	}
...
func runConfigCIGitHub(
	...
	writer ci.WorkflowWriter,
	getCgb common.GetCgbFunc,
	getCwd common.GetCwdFunc,
) error {
	cfg, err := ci.NewCIGitHubConfig(getCgb, getCwd)
	if err != nil {
		return err
	}
