...
func TestNewConfigCICmd_BranchFlagResolution(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			branchArg:      "--branch=" + masterBranch,
			gitCliReturn:   issueBranch,
			expectedBranch: masterBranch,
		},
	}
