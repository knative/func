...
func Test_validatePipeline(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			function: fn.Function{Runtime: "node", Build: fn.BuildSpec{Builder: builders.Pack}},
			wantErr:  false,
		},
		{
			name:     "Supported runtime - s2i builder",
			function: fn.Function{Runtime: "node", Build: fn.BuildSpec{Builder: builders.S2I}},
			wantErr:  false,
		},
		{
			name:     "Supported runtime - pack builder - with additional Buildpacks",
			function: fn.Function{Runtime: "node", Build: fn.BuildSpec{Builder: builders.Pack, Buildpacks: testBuildpacks}},
			wantErr:  true,
		},
		{
