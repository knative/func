...
func handleCreateHelpResource(ctx context.Context, request mcp.ReadResourceRequest) ([]mcp.ResourceContents, error) {
	return runHelpCommand("create", "func://create/docs")
}

func handleBuildHelpResource(ctx context.Context, request mcp.ReadResourceRequest) ([]mcp.ResourceContents, error) {
	return runHelpCommand("build", "func://build/docs")
}

func handleDeployHelpResource(ctx context.Context, request mcp.ReadResourceRequest) ([]mcp.ResourceContents, error) {
	return runHelpCommand("deploy", "func://deploy/docs")
}

func handleListHelpResource(ctx context.Context, request mcp.ReadResourceRequest) ([]mcp.ResourceContents, error) {
	return runHelpCommand("list", "func://list/docs")
}

func handleDeleteHelpResource(ctx context.Context, request mcp.ReadResourceRequest) ([]mcp.ResourceContents, error) {
