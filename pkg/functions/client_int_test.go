...
func TestInt_Remove(t *testing.T) {
	...
	waitFor(t, client, name, DefaultIntTestNamespace)
...
func del(t *testing.T, c *fn.Client, name, namespace string) {
	...
	// FIXME(lkingland):  The below breaks things
	...
	//
	// TODO(lkingland): Check with Jefferson what caused such a state, open an
