...
func (l *Lister) List(ctx context.Context, namespace string) ([]fn.ListItem, error) {
	...
	for _, service := range services.Items {
		...
		item, err := l.get(ctx, clientset, httpScaledObjectClientset, service.Name,
...
// object up again.
func (l *Lister) get(ctx context.Context, clientset *kubernetes.Clientset, httpScaledObjectClientset *versioned.Clientset, name, namespace, runtime, exposedHost string) (fn.ListItem, error) {
