...
func (f *Factory) LauncherLayer(path string) (layer Layer, err error) {
	...
	return f.writeLayer("buildpacksio/lifecycle:launcher", func(tw *archive.NormalizingTarWriter) error {
...
func (f *Factory) ProcessTypesLayer(config launch.Metadata) (layer Layer, err error) {
	...
	return f.writeLayer("buildpacksio/lifecycle:process-types", func(tw *archive.NormalizingTarWriter) error {
